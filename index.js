...
// Railway biasanya pakai PORT dari env variable
...
async function scrapeKuramanime() {
    ...
    // Pakai launch dengan argumen khusus untuk server Linux tanpa GUI
    ...
    for (const anime of animeList) {
        ...
        const episode = await page.evaluate(() => {
            ...
            const epElement = epButtons[epButtons.length - 1]; // ambil elemen terakhir (episode terbaru)
